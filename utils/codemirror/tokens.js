...
import {
  ...
  formatString1Brace,
  formatString1End,
  formatString2Content,
  formatString2Brace,
  formatString2End,
  formatString1lContent,
  formatString1lBrace,
  formatString1lEnd,
  ...
  return new ExternalTokenizer((input) => {
    ...
    for (;;) {
      if (input.next < 0) {
        ...
        input.next == quote &&
        (len == 1 || (input.peek(1) == quote && input.peek(2) == quote))
      ) {
        if (input.pos == start) {
...
export const formatString1 = formatString(
  singleQuote,
  1,
  formatString1Content,
  formatString1Brace,
...
export const formatString2 = formatString(
  doubleQuote,
  1,
  formatString2Content,
  formatString2Brace,
...
export const formatString1l = formatString(
  singleQuote,
  3,
  formatString1lContent,
  formatString1lBrace,
...
export const formatString2l = formatString(
  doubleQuote,
  3,
  formatString2lContent,
  formatString2lBrace,
